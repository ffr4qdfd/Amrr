...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/O8_2K")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/H_HG8")

SUDO_USERS = list(map(int, getenv("SUDO_USERS", "6625922221").split()))
